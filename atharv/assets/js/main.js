...
(function () {
  ...
  (function () {
    ...
    var settings = {
      ...
      images: {
        "images/harsha.jpg": "center",
        "images/gautam.jpg": "center",
        "images/aashish.jpg": "center",
        "images/sanjana.jpg": "center",
        "images/anirudh.jpg": "center",
        "images/shivani.jpg": "center",
        "images/vamika.jpg": "center",
        "images/sanjeev.jpg": "center",
        "images/sivam.jpg": "center",
        "images/darrin.jpg": "center",
      },
  ...
  (function () {
    ...
    $form.addEventListener("submit", function (event) {
      ...
      window.setTimeout(function () {
        ...
        // Show message.
        if (document.getElementById("secret").innerHTML === "vomissa") {
          $message._show(
            "success",
            "Correct Answer! Your gift is a CS GO Asiimov skin!"
          );
        } else {
          $message._show("failure", "Incorrect. Please try again.");
        }
      }, 750);
    });
  })();
